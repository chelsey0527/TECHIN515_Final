...
export default function IndexSectionTaMenus1() {
    return (
        <React.Fragment>
            <>
                <div>
  ...
  <div className="mx-auto lg:ml-80">
    ...
    <h1 className="font-bold font-heading container mx-auto px-10 pt-8 text-4xl">Track Your Device</h1>
    <div className="container px-4 mx-auto">
      <div className="flex flex-wrap -mx-4 -mb-4 md:mb-0">
        <div className="w-full md:w-1/3 px-4 mb-4 md:mb-0 ml-6">
        </div>
        <div className="w-full md:w-2/3 px-4 mb-4 md:mb-0">
        </div>
      </div>
      <div className="flex flex-wrap -mx-4 -mb-4 md:mb-0">
        <div className="w-full md:w-1/3 mb-4 md:mb-0 content-center pl-10">
          <div className="bg-white p-8 h-full content-center">
            <p className="pb-10">Clikc the button below to find your MediBox!</p>
            <a className="inline-block w-full md:w-auto px-6 py-3 font-medium text-white bg-indigo-500 hover:bg-indigo-600 rounded transition duration-200" href="#">Track My Device</a>
          </div>
        </div>
        <div className="w-full md:w-2/3 px-4 mb-4 md:mb-0 pr-10">
          <img className="rounded mr-8 p-8 bg-white" src="https://images.unsplash.com/photo-1620203178232-3619475228a9?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=960&q=80" alt="" /></div>
      </div>
    </div>
  </div>
</div>
